    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 18) {
            VStack(alignment: .leading, spacing: 4) {
                Text("🧠 Muze").font(.largeTitle.bold())
            ...
            permissionRow(
                ...
                detail: "Required to capture frames. Without it Muze sees only your wallpaper.",
            ...
            Text("After granting Screen Recording, macOS requires Muze to be relaunched.")
                .font(.caption).foregroundStyle(.secondary)

            HStack {
                Spacer()
                Button("Relaunch Muze") { relaunch() }
